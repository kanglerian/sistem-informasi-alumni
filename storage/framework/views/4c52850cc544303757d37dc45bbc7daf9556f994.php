        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-10 col-xl-7">
                    <h2 class="header-title">Cari Data <strong>Alumni</strong></h2>
                    <form action="<?php echo e(route('search-mhs')); ?>" method="GET">
                        <?php echo csrf_field(); ?>
                        <div class="input-group search-bar">
                            <input type="text" class="form-control search-input" name="search" placeholder="Cari data alumni..">
...
</html><?php /**PATH /Users/mjlq2/Documents/Lerian/project-ta/resources/views/layouts/dataMahasiswa.blade.php ENDPATH**/ ?>